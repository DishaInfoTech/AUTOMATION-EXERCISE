...
You should consider logging some description.

It should be obvious that the main 'application' code should be generic work with examples other than those specified in
the tests.
...
3. Google - Implement the pre-written scenarios using Selenium Web driver. The Driver is configured to use chrome.
...
See the example change password screen. ExampleChangePasswordScreen.PNG
You may assume that the change of password has been initiated.